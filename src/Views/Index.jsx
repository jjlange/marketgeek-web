...
function Index() {
  ...
  const handleSignIn = (event) => {
    ...
    if (emailValue === "") {
      ...
      setSignInMessage(
        "We need your email address that is associated with your account."
      );
    } else {
      ...
      if (passwordValue === "") {
        ...
        setSignInMessage(
          "We need your password that you used to register your account."
        );
      } else {
        // Handle Sign In using Axios to the API and .env server url

        axios
          .post(process.env.REACT_APP_SERVER_URL + "/user/auth", {
            email: emailValue,
            ...
            (response) => {
              ...
              if (response.data.accessToken) {
                ...
                if (response.data.message === "password_incorrect") {
                  setSignInMessage(
                    "Whoops, that's wrong.  Please check your details."
                  );
                } else {
        ...
        <div className="relative text-gray-800 w-full md:max-w-6xl sm:max-w-8xl mx-auto">
            ...
            <div className="flex items-center">
              <div className="w-full flex">
                <h2 className="inline-flex text-2xl md:text-3xl font-bold items-center text-gray-800 dark:text-gray-200 mr-4">
                  ...
                  MarketGeek
                  {devMode === true && (
                    <span className="text-sm font-thin mx-3 pt-1">
                      DEV BUILD
                    </span>
                  )}
                </h2>
              ...
              <div className="w-full justify-end flex items-center">
                <span className="hidden md:block dark:text-gray-200 mr-4 ml-4">
                  Already have an account?
                </span>
                <button
                  onClick={openModal}
                  type="button"
                  className="mx-2 inline-flex items-center px-4 md:px-6 py-[0.4em] border text-base border-transparent font-medium rounded-lg text-white bg-sky-800/80 hover:bg-sky-800/70 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition ease-in">
                  Sign In
          ...
          {signUpStep === 1 && (
            <Modal
              ...
              onClose={closeSignUpModal}></Modal>
          )}
          ...
          <div className="mx-auto mt-16">
            <div className="max-w-3xl">
              <h2 className="font-medium md:font-light text-3xl md:text-5xl mt-8 text-gray-900 break-normal       leading-[1.5em] dark:text-gray-200 max-w-xl md:max-w-full">
                Join the platform that intelligently predicts the market of
                tomorrow.
              </h2>
            ...
            */}
            ...
            <div className="grid md:gap-4 w-full">
              <div className="border border-gray-100 dark:border-gray-800 col-span-2 md:col-span-1 p-8 rounded-lg bg-white/90 dark:bg-gray-800/50 mt-16 md:shadow-2xl">
                <h2 className="text-lg font-bold text-sky-700 dark:text-sky-400 uppercase">
                  Designed for Everyone
                </h2>
                <h3 className="text-2xl mt-2 text-gray-800 dark:text-slate-100 break-words leading-normal font-normal">
                  Sit amet, consectetur adipiscing elit. Curabitur ullamcorper
                  tincidunt purus ac vulputate.
                  <br />
                  <br /> Quisque id dui ac lorem eleifend rhoncus. Fusce non
                  ipsum pharetra, ornare orci in, mattis sem.
                </h3>
              </div>
              <div className="border border-gray-100 dark:border-gray-800 col-span-2 md:col-span-1 p-8 rounded-lg bg-white/90 dark:bg-gray-800/50 mt-4 md:mt-16 md:shadow-2xl">
                <h2 className="text-lg font-bold text-red-600 dark:text-red-400 uppercase">
                  We &nbsp;❤️&nbsp; Trading
                </h2>
                <h3 className="text-2xl mt-2 text-gray-800 dark:text-slate-100 break-words leading-normal font-normal">
                  Sit amet, consectetur adipiscing elit. Curabitur ullamcorper
              ...
              <div className="border border-gray-100 dark:border-gray-800 col-span-2 p-8 rounded-lg bg-white/90 dark:bg-gray-800/50 mt-4 md:shadow-2xl">
                <h2 className="text-lg font-bold text-yellow-600 dark:text-yellow-400 uppercase">
                  Up for a challenge?
                </h2>
                <h3 className="text-2xl mt-2 text-gray-800 dark:text-slate-100 break-words leading-normal font-normal">
                  Sit amet, consectetur adipiscing elit. Curabitur ullamcorper
                ...
                <button
                  type="button"
                  className="mt-6 inline-flex items-center px-5 py-3 border text-base border-transparent font-medium rounded-full text-black bg-yellow-500/80 dark:bg-yellow-200 hover:bg-yellow-500/70 dark:hover:bg-yellow-600/70 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 dark:focus:ring-yellow-500 transition ease-in">
                  Learn More
                </button>
              </div>
            </div>
