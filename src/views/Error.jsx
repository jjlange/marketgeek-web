  ...
  return (
    <div className="bg-gray-800/90 flex text-white font-nunito h-screen">
      <div className="m-auto">
        ...
        <br /><br />
        <a href="/" className="text-xl p-2 font-semibold text- rounded-md px-6 py-2.5 bg-cyan-200  shadow-cyan-200 hover:bg-cyan-200/90 hover:shadow-cyan-200/90 transition ease-in-out duration-400">Reload Page</a>

        <div className="text-gray-100 p-4 mt-6">
          <p>Copyright © 2022 - <a href="/" className="text-gray-100">MarketGeek</a>. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
