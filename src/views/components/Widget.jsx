...
const Widget = props => {
    ...
    return (
        <div className={"flex w-full border border-gray-100 dark:border-gray-800 col-span-" + props.columns + " pt-2 pb-4 pl-6 pr-6 rounded-lg bg-white/90 dark:bg-gray-800/50 mt-12 md:shadow-2xl items-center " + textAlign + ""}>
